...
(defun e-quotients (count)
  "Generate COUNT of the quotients of the representation of e."
  (iter (for i from 1 to (ceiling count 3))
	(collect 1 into result)
	(collect (* i 2) into result)
	(collect 1 into result)
	(finally
	 (return (subseq (cons 2 result)
			 0 count)))))
...
(defun euler-65 ()
  (sum-digits
   (numerator
    (expand-fraction (e-quotients 100)))))
