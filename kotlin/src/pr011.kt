...
class Pr011 : EulerSolution<Int>() {
    override val answer = 70600674
    override val num = 11
    ...
    private val deltas = arrayOf(Delta(0, 1), Delta(1, 0), Delta(1, 1), Delta(1, -1))

    // Try to find a product along the delta, returning 0 if it goes
    // out of bounds.
    private fun product(x: Int, y: Int, d: Delta): Int {
        var px = x
        var py = y
        var prod = 1
